...
const AuthContextProvider = ({ children }) => {
    ...
    useEffect(() => await loadUser(), []); //Chạy lần đầu tiên khi re-render
    ...
    // Context data
    const authContextData = { loginUser, authState }; // Xuất thằng login use này đi bằng useContext (Hiểu đơn giản lưu vào value bên dưới để truyền function này đi bất kì đâu)
