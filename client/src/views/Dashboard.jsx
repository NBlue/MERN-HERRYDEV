...
const Dashboard = () => {
    ...
    // Start get all post:
    // Nếu viết: useEffect(() => getPosts(), []): tức là nó return ra cái hàm getpost kia nên sẽ lỗi - Cái cần mình chỉ cần gọi chạy hàm thôi
    useEffect(() => {
        getPosts();
        // return () => {
        //     console.log("Phải return về gì đó ko nó sẽ lỗi");
        // };
    }, []);
